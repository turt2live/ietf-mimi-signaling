...
A hub server, however, MUST persist the auth events chain for the room. This is to guarantee
the room is portable in the event of a hub transfer.

**OPEN QUESTION**: Hub transfers as a whole are not concretely specified.

**TODO(TR): Hash chaining discussion outcomes
([GH issue](https://github.com/turt2live/ietf-mimi-signaling/issues/7))**
